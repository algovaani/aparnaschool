...
class Feestatusunpaid extends Admin_Controller
{
    ...
    public function index()
    {
                ...
                if(!empty($record->fees)){
                    foreach($record->fees as $_rec_fees){
                        ...
                        if(!empty($_rec_fees->amount_detail)){
                            ...
                            // Corrected logic to handle 100% discount for the report display
                            ...
                            if ($is_fully_discounted) {
                                // If 100% discount, the 'Paid' amount is the full fee amount.
        ...
        $this->load->view('reports/_fees_report_type_unpaid', $data);
