                                                ...
                                                foreach ($fee_deposits as $fee_deposits_key => $fee_deposits_value) {
                                                    ...
                                                    <tr class="white-td">
                                                        ...
                                                        if($fee_deposits_value->amount == $fee_deposits_value->amount_discount){
                                                            ...
                                                            echo ($currency_symbol . amountFormat($fee_deposits_value->amount_discount, 2));
                                                        }
                                                        //echo ($currency_symbol . amountFormat($fee_deposits_value->amount_discount)); ?></td>
                                                ...
                                                if (is_object($fee_deposits)) {
                                                    ...
                                                    foreach ($fee_deposits as $fee_deposits_key => $fee_deposits_value) {
                                                        ...
                                                        <tr class="white-td">
                                                            ...
                                                            echo ($currency_symbol . amountFormat($fee_deposits_value->amount_fine)); 
                                                            ?></td>
                                                            <td class="text text-right"><?php
                                                            if($fee_deposits_value->amount == $fee_deposits_value->amount_discount){
                                                                echo ($currency_symbol . "0.00");
