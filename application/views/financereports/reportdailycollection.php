                            ...
                            <div class="row">
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <input id="date_from" name="date_from" type="text" class="form-control date" value="<?php echo set_value('date_from') ?>" autocomplete="off">
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <input id="date_to" name="date_to" type="text" class="form-control date" value="<?php echo set_value('date_to') ?>" autocomplete="off">
                    ...
                    <div class="row">
                        <?php if (isset($fees_data)) { ?>
                            <div id="transfee">
                                ...
                                <div class="box-body">
                                    <?php
                                    // Filter out fully discounted (0 amount) transactions
                                    $filtered_fees_data = array_filter($fees_data, function ($value) {
                                        return isset($value['amt']) && $value['amt'] > 0;
                                    });

                                    if (!empty($filtered_fees_data)) {
                                        $total_amount = 0;
                                    ?>
                                        <div class="table-responsive">
                                            ...
                                            <table class="table table-striped table-bordered table-hover example">
                                                ...
                                                <tbody>
                                                    <?php foreach ($filtered_fees_data as $fee_key => $fee_value) {
