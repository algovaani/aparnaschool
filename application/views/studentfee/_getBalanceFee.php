...
<div class="content-wrapper">
            ...
            <aside class="studentsidebar">
                <div class="stutop" id="">
                    ...
                    <div class="studentsidetopfixed">
                        <p class="classtap"><?php echo $student[
                            "class"
                        ]; ?><a href="#" data-toggle="control-sidebar" class="studentsideclose"><i class="fa fa-times"></i></a></p>
                        <ul class="nav nav-justified studenttaps">
                            <?php foreach (
                                ...
                                <li <?php if (
                                    ...
                                    echo "class='active'";
                                } ?> ><a href="#section<?php echo $svalue[
     "section_id"
                    ...
                    <div class="tab-content">
                        <?php foreach ($class_section as $skey => $snvalue) { ?>
                            <div class="tab-pane <?php if (
                                $student["section_id"] == $snvalue["section_id"]
                            ) {
                                echo "active";
                            } ?>" id="section<?php echo $snvalue[
    "section_id"
]; ?>">
                                 <?php foreach (
                                     ...
                                     if (
                                        ...
                                        <div class="studentname">
                                            <a class="" href="<?php echo base_url() .
                                                ...
                                                <div class="icon"><img src="<?php echo base_url() .
                                                    $stvalue["image"] .
                                                    img_time(); ?>" alt="User Image"></div>
                                                <div class="student-tittle"><?php echo $stvalue[
                                                    "firstname"
                                                ] .
                                                    " " .
                                                    $stvalue[
                            ...
                            <div class="col-md-8">
                                <div class="btn-group pull-right">
                                    <a href="<?php echo base_url(); ?>studentfee" type="button" class="btn btn-primary btn-xs">
                                        <i class="fa fa-arrow-left"></i> <?php echo $this->lang->line(
                                            "back"
                                        ); ?></a>
                                </div>
                            </div>
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="sfborder-top-border">
                                    <div class="col-md-2">
                                        <img width="115" height="115" class="mt5 mb10 sfborder-img-shadow img-responsive img-rounded" src="<?php if (
                                            !empty($student["image"])
                                        ) {
                                            echo $this->media_storage->getImageURL(
                                                $student["image"]
                                            );
                                        } else {
                                            if (
                ...
                " alt="No Image">
                                    ...
                                    <div class="col-md-10">
                                        <div class="row">
                                            <table class="table table-striped mb0 font13">
                                                <tbody>
                                                    <tr>
                                                        <th class="bozero"><?php echo $this->lang->line(
                                                            "name"
                                                        ); ?></th>
                                                        <td class="bozero"><?php echo $this->customlib->getFullName(
                                                            $student[
                                                                "firstname"
                                                            ],
                                                            $student[
                                                        ...
                                                        <td class="bozero"><?php echo $student[
                                                            "class"
                                                        ] .
                                                            " (" .
                                                            $student[
                                                    ...
                                                    <tr>
                                                        ...
                                                        <?php if (
                                                            ...
                                                            <td><b class="text-danger"> <?php echo $student[
                                                                "rte"
                                                            ]; ?> </b>
                                                            </td>
                                                        <?php } ?>
                        ...
                        <div class="row no-print mb10">
                            <div class="col-md-12 mDMb10">
                                ...
                                <button type="button" class="btn btn-sm btn-info printSelected" id="load" data-loading-text="<i class='fa fa-spinner fa-spin '></i> <?php echo $this->lang->line(
                                    "please_wait"
                                ); ?>"><i class="fa fa-print"></i> <?php echo $this->lang->line(
    "print_selected"
); ?></button>
                                <?php if (
                                ...
                                <button type="button" class="btn btn-sm btn-warning collectSelected" id="load" data-loading-text="<i class='fa fa-spinner fa-spin '></i> <?php echo $this->lang->line(
                                    "please_wait"
                                ); ?>"><i class="fa fa-money"></i> <?php echo $this->lang->line(
    "collect_selected"
); ?></button><?php } ?>
                                <?php if ($student_processing_fee) { ?>
                                    <a  href="javascript:void(0)" class="btn btn-sm btn-info getProcessingfees" data-loading-text="<i class='fa fa-spinner fa-spin '></i> <?php echo $this->lang->line(
                                        "please_wait"
                                    ); ?>"><i class="fa fa-money"></i> <?php echo $this->lang->line(
    "processing_fees"
); ?></a>
                                <?php } ?>                              </div>
                                <span class="pull-right pt5"><?php echo $this->lang->line(
                                    "date"
                                ); ?>: <?php echo date(
    $this->customlib->getSchoolDateFormat()
                        ...
                        <div class="table-responsive overflow-y-hidden">
                            <div class="download_label"><?php echo $this->lang->line(
                                "student_fees"
                            ) .
                                ": " .
                                $student["firstname"] .
                                " " .
                                $student["lastname"] .
                                $student_admission_no; ?> </div>
                            <table class="table table-striped table-bordered table-hover example table-fixed-header">
                                <thead class="header">
                                    <tr>
                                        <th style="width: 10px"><input type="checkbox" id="select_all"/></th>
                                        <th align="left"><?php echo $this->lang->line(
                                            "fees"
                                        ); ?></th>
                                        <th align="left" class="text text-left"><?php echo $this->lang->line(
                                            "due_date"
                                        ); ?></th>
                                        <th align="left" class="text text-left"><?php echo $this->lang->line(
                                            "status"
     ...
     $currency_symbol .
     ")"; ?></span></th>
                                        <th class="text text-right noExport"><?php echo $this->lang->line(
                                            "action"
                                        ); ?></th>
                                    </tr>
                                </thead>
                                        ...
                                        foreach (
                                            ...
                                            if (
                                                ...
                                                if (
                                                    ...
                                                    $due_days = $diff->format(
                                                        "%a"
                                                    );

                                                    if (
                                                        $this->customlib->get_cumulative_fine_amount(
                                                            $fee_value->fee_groups_feetype_id,
                                                            $due_days
                                                        )
                                                    ) {
                                                        $due_fine_amount = $this->customlib->get_cumulative_fine_amount(
                                                            $fee_value->fee_groups_feetype_id,
                                                            $due_days
                                                        );
                                                    } else {
                                            ...
                                            ?>
        <?php if (
            !empty($fee_value->due_date) &&
            $feetype_balance > 0 &&
            strtotime($fee_value->due_date) < strtotime(date("Y-m-d"))
        ) { ?>
            ...
            <td><?php if ($fee_value->is_system) {
                echo $this->lang->line($fee_value->type) .
                    " (" .
                    $this->lang->line($fee_value->code) .
                    ")";
            } else {
                echo $fee_value->type . " (" . $fee_value->code . ")";
            } ?></td>

            <td align="left" class="text text-left"><?php if (
            ...
            <td align="left" class="">
            <?php if (
                $feetype_balance == 0 || $fee_discount == $fee_value->amount || !empty($fee_discount)
    ...
    "unpaid"
            ...
            <span data-toggle="popover" class="text text-danger detail_popover"><?php echo " + " .
                amountFormat($fees_fine_amount); ?></span>
...
?> </td>
            <td class="text text-right"><?php echo amountFormat(
                $fee_fine
            ); ?></td>
            <td class="text text-right"><?php
if ($fee_discount == $fee_value->amount){
...
?></td>
            ...
            <div class="btn-group">
                <div class="pull-right"><?php if (
                    $this->rbac->hasPrivilege("collect_fees", "can_add")
                ) { ?>
                                                        <button type="button" data-student_session_id="<?php echo $fee->student_session_id; ?>" data-student_fees_master_id="<?php echo $fee->id; ?>" data-fee_groups_feetype_id="<?php echo $fee_value->fee_groups_feetype_id; ?>" data-group="<?php echo $fee_value->is_system
    ? $this->lang->line($fee_value->name) .
        " (" .
        $this->lang->line($fee_value->type) .
        ")"
    : $fee_value->name .
        " (" .
        $fee_value->type .
        ")"; ?>"  data-type="<?php echo $fee_value->is_system
    ? $this->lang->line($fee_value->type)
    : $fee_value->code; ?>"
                                                                class="btn btn-xs btn-default myCollectFeeBtn <?php echo $display_none; ?>"
                                                                title="<?php echo $this->lang->line(
                                                                    "add_fees"
                                                                ); ?>" data-toggle="modal" data-target="#myFeesModal" data-fee-category="fees"  data-trans_fee_id="0"
                                                      ><i class="fa fa-plus"></i></button><?php } ?>

<button  class="btn btn-xs btn-default printInv" data-student_session_id="<?php echo $fee->student_session_id; ?>" data-fee_master_id="<?php echo $fee_value->id; ?>" data-fee_session_group_id="<?php echo $fee_value->fee_session_group_id; ?>" data-fee_groups_feetype_id="<?php echo $fee_value->fee_groups_feetype_id; ?>" data-fee-category="fees"  data-trans_fee_id="0" title="<?php echo $this->lang->line(
    "print"
); ?>" data-loading-text="<i class='fa fa-spinner fa-spin '></i>"><i class="fa fa-print"></i></button>
                                                    </div>
                                                  </div>
                                                </td>
                                            </tr>
                                            <?php if (
                                                ...
                                                foreach (
                                                    ...
                                                    <tr class="white-td">
                                                        ...
                                                        <td align="left"></td>
                                                        <td align="left"></td>
                                                        <td class="text-right"><img src="<?php echo $this->media_storage->getImageURL(
                                                            "backend/images/table-arrow.png"
                                                        ); ?>" alt="" /></td>
                                                        <td class="text text-left"><a href="#" data-toggle="popover" class="detail_popover" > <?php echo $fee_value->student_fees_deposite_id .
                                                            "/" .
                                                        ...
                                                        <td class="text text-left"><?php echo $this->lang->line(
                                                            strtolower(
                                                                $fee_deposits_value->payment_mode
                                                            )
                                                        ); ?></td>
                                                        ...
                                                        <td class="text text-right"><a href="#" class="text text-right display-inline" title="<?php echo $this->lang->line(
                                                            "discount"
                                                        ); ?>" data-fee-deposite-id="<?php echo $fee_value->student_fees_deposite_id; ?>" data-toggle="modal" data-target="#myfeeDiscountModal"><?php 
                                                            if ($fee_discount == $fee_value->amount){
                                                                echo '0.00';
                                                            } else {
                                                            ...
                                                            <div class="btn-group">
                                                               <div class="pull-right">
                                                                <?php if (
                                                                    ...
                                                                    <button class="btn btn-default btn-xs" data-invoiceno="<?php echo $fee_value->student_fees_deposite_id .
                                                                        "/" .
                                                                        $fee_deposits_value->inv_no; ?>" data-main_invoice="<?php echo $fee_value->student_fees_deposite_id; ?>" data-sub_invoice="<?php echo $fee_deposits_value->inv_no; ?>" data-toggle="modal" data-target="#confirm-delete" title="<?php echo $this->lang->line(
    "revert"
); ?>">
                                                                        <i class="fa fa-undo"> </i>
                                                                    </button>
                                                                <?php } ?>
                                                                <button  class="btn btn-xs btn-default printDoc" data-main_invoice="<?php echo $fee_value->student_fees_deposite_id; ?>" data-sub_invoice="<?php echo $fee_deposits_value->inv_no; ?>"  title="<?php echo $this->lang->line(
    "print"
...
<?php if (!empty($transport_fees)) {
    foreach ($transport_fees as $transport_fee_key => $transport_fee_value) {
        ...
        if (!empty($transport_fee_value->amount_detail)) {
            ...
            foreach (
                $fee_deposits
                as $fee_deposits_key => $fee_deposits_value
            ) {
        ...
        $feetype_balance =
            $transport_fee_value->fees - ($fee_paid + $fee_discount);

        if (
            $transport_fee_value->due_date != "0000-00-00" &&
            $transport_fee_value->due_date != null &&
            strtotime($transport_fee_value->due_date) < strtotime(date("Y-m-d"))
        ) {
            $fees_fine_amount = is_null($transport_fee_value->fine_percentage)
                ? $transport_fee_value->fine_amount
                : percentageAmount(
                    $transport_fee_value->fees,
                    $transport_fee_value->fine_percentage
                );
            $total_fees_fine_amount =
        ...
        ?>
                <td>
                    ...
                    <td align="left" class="text-rtl-right"><?php echo $this->lang->line(
                        "transport_fees"
                    ) .
                        " (" .
                        $transport_fee_value->month .
                        ")"; ?></td>
                    <td align="left" class="text text-left">
<?php echo $this->customlib->dateformat(
    $transport_fee_value->due_date
); ?> </td>
    ...
    "paid"
                                                        ...
                                                        !empty(
                                                            $transport_fee_value->amount_detail
                                                        )
                                                    ) { ?><span class="label label-warning"><?php echo $this->lang->line(
    "partial"
); ?></span><?php } else { ?><span class="label label-danger"><?php echo $this->lang->line(
    "unpaid"
            ...
            if (
                $transport_fee_value->due_date != "0000-00-00" &&
                $transport_fee_value->due_date != null &&
                strtotime($transport_fee_value->due_date) <
                    strtotime(date("Y-m-d"))
            ) {

                $tr_fine_amount = $transport_fee_value->fine_amount;
                if (
                    $transport_fee_value->fine_type != "" &&
                    $transport_fee_value->fine_type == "percentage"
                ) {
                    $tr_fine_amount = percentageAmount(
                        $transport_fee_value->fees,
                        $transport_fee_value->fine_percentage
                    );
                }
...
<span data-toggle="popover" class="text text-danger detail_popover"><?php echo " + " .
    amountFormat($tr_fine_amount); ?></span>
<div class="fee_detail_popover" style="display: none">
    ...
    <?php
            ...
            ?>   </td>
                ...
                <td class="white-space-nowrap"><?php if (
                    $this->rbac->hasPrivilege("collect_fees", "can_add")
                ) { ?>
                    <button type="button" data-student_session_id="<?php echo $transport_fee_value->student_session_id; ?>" data-student_fees_master_id="0" data-fee_groups_feetype_id="0"  data-group="<?php echo $this->lang->line(
    "transport_fees"
); ?>"  data-type="<?php echo $transport_fee_value->month; ?>" class="btn btn-xs btn-default myCollectFeeBtn <?php echo $display_none; ?>"  title="<?php echo $this->lang->line(
    "add_fees"
); ?>" data-toggle="modal" data-target="#myFeesModal" data-fee-category="transport" data-trans_fee_id="<?php echo $transport_fee_value->id; ?>"><i class="fa fa-plus"></i></button><?php } ?>

                    <button  class="btn btn-xs btn-default printInv"  data-student_session_id="<?php echo $transport_fee_value->student_session_id; ?>" data-fee_master_id="0" data-fee_session_group_id="0" data-fee_groups_feetype_id="0" data-fee-category="transport"  data-trans_fee_id="<?php echo $transport_fee_value->id; ?>" title="<?php echo $this->lang->line(
    "print"
); ?>" data-loading-text="<i class='fa fa-spinner fa-spin '></i>"><i class="fa fa-print"></i></button>
                </td>
                </tr>
...
<?php if (!empty($transport_fee_value->amount_detail)) {
    ...
    foreach ($fee_deposits as $fee_deposits_key => $fee_deposits_value) { ?>
                                                    <tr class="white-td">
                                                        ...
                                                        <td class="text text-left">
                                                            <a href="#" data-toggle="popover" class="detail_popover" > <?php echo $transport_fee_value->student_fees_deposite_id .
                                                                "/" .
                                                                $fee_deposits_value->inv_no; ?></a>
                                                            <div class="fee_detail_popover" style="display: none">
                                                                <?php if (
														...
														<td class="text text-right"><a href="#" class="text text-right display-inline" title="<?php echo $this->lang->line(
                  "discount"
              ); ?>" data-fee-deposite-id="<?php echo $transport_fee_value->student_fees_deposite_id; ?>" data-toggle="modal" data-target="#myfeeDiscountModal"><?php echo amountFormat(
    $fee_deposits_value->amount_discount
); ?></a></td>
                                                        <td class="text text-right"><?php echo amountFormat(
                                                            $fee_deposits_value->amount_fine
                                                            ...
                                                            <div class="btn-group ">
                                                               <div class="pull-right">
                                                                <?php if (
                                                                    ...
                                                                    <button class="btn btn-default btn-xs" data-invoiceno="<?php echo $transport_fee_value->student_fees_deposite_id .
                                                                        "/" .
                                                                        $fee_deposits_value->inv_no; ?>" data-main_invoice="<?php echo $transport_fee_value->student_fees_deposite_id; ?>" data-sub_invoice="<?php echo $fee_deposits_value->inv_no; ?>" data-toggle="modal" data-target="#confirm-delete" title="<?php echo $this->lang->line(
    "revert"
); ?>">
                                                                        <i class="fa fa-undo"> </i>
                                                                    </button>
                                                                <?php } ?>
                                                                <button  class="btn btn-xs btn-default printDoc" data-fee-category="transport" data-main_invoice="<?php echo $transport_fee_value->student_fees_deposite_id; ?>" data-sub_invoice="<?php echo $fee_deposits_value->inv_no; ?>"  title="<?php echo $this->lang->line(
    "print"
); ?>"><i class="fa fa-print"></i></button>
                                                            </div>
                                                          </div>
...
<?php
                                    ...
                                    <tr class="box box-solid total-bg">                                       
                                        ...
                                        <td align="left" ></td>
                                        <td align="left" ></td>
                                        <td align="left" class="text text-left" ><?php echo $this->lang->line(
                                            "grand_total"
                                        ); ?></td>
                                        <td class="text text-right">
...
<span data-toggle="popover" class="text text-danger detail_popover"><?php echo " + " .
    amountFormat($total_fees_fine_amount); ?></span>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
                ...
                <div class="form-horizontal">
                    <div class="box-body">
                        ...
                        <div class="form-group">
                            <label for="inputPassword3" class="col-sm-3 control-label"><?php echo $this->lang->line(
                                "payment_id"
            ...
            <div class="modal-footer">
                <button type="button" class="btn btn-default pull-left" data-dismiss="modal"><?php echo $this->lang->line(
                    "cancel"
                ); ?></button>
                <button type="button" class="btn cfees dis_apply_button" id="load" data-loading-text="<i class='fa fa-circle-o-notch fa-spin'></i> <?php echo $this->lang->line(
                    "processing"
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <p><?php echo $this->lang->line(
                    "are_you_sure_want_to_revert"
                ); ?> <b class="discount_title"></b> <?php echo $this->lang->line(
     "discount_this_action_is_irreversible"
 ); ?></p>
                <p><?php echo $this->lang->line(
            ...
            <div class="modal-footer">
                ...
                <a class="btn btn-danger btn-discountdel"><?php echo $this->lang->line(
                    "revert"
                ); ?></a>
            </div>
        </div>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                ); ?> <b class="invoice_no"></b> <?php echo $this->lang->line(
     "invoice_this_action_is_irreversible"
 ); ?></p>
                 <p><?php echo $this->lang->line(
                     "do_you_want_to_proceed"
                 ); ?></p>
            ...
            <div class="modal-footer">
                ...
                <a class="btn btn-danger btn-ok"><?php echo $this->lang->line(
                    "revert"
                ); ?></a>
            </div>
        </div>
...
<div id="listCollectionModal" class="modal fade">
    <div class="modal-dialog">
        <form action="<?php echo site_url(
            "studentfee/addfeegrp"
        ); ?>" method="POST" id="collect_fee_group">
            <div class="modal-content">
<!-- //================ -->
 <input  type="hidden" class="form-control" id="group_std_id" name="student_session_id" value="<?php echo $student[
     "student_session_id"
 ]; ?>" readonly="readonly"/>
<input  type="hidden" class="form-control" id="group_parent_app_key" name="parent_app_key" value="<?php echo $student[
    "parent_app_key"
]; ?>" readonly="readonly"/>
<input  type="hidden" class="form-control" id="group_guardian_phone" name="guardian_phone" value="<?php echo $student[
    "guardian_phone"
]; ?>" readonly="readonly"/>
<input  type="hidden" class="form-control" id="group_guardian_email" name="guardian_email" value="<?php echo $student[
    "guardian_email"
]; ?>" readonly="readonly"/>
<!-- //================ -->
                <div class="modal-header">
                    <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
                    <h4 class="modal-title"><?php echo $this->lang->line(
                        "collect_fees"
                    ); ?></h4>
                </div>
                <div class="modal-body">
...
<script type="text/javascript">
    ...
    $(document).ready(function () {
            ...
            var student_session_id = '<?php echo $student[
                "student_session_id"
            ]; ?>';
            $.ajax({
        ...
        $('#confirm-discountdelete').on('click', '.btn-discountdel', function (e) {
            ...
            $.ajax({
                ...
                url: '<?php echo site_url(
                    "studentfee/deleteStudentDiscount"
                ); ?>',
                dataType: 'JSON',
...
$("#myfeeDiscountModal").on('shown.bs.modal', function (e) {
        e.stopPropagation();
        $('.fees_discount_title').html("<?php echo $this->lang->line(
            "discount"
        ); ?>");
...
$("#myFeesModal").on('shown.bs.modal', function (e) {
        e.stopPropagation();
        var discount_group_dropdown = '<option value=""><?php echo $this->lang->line(
            "select"
        ); ?></option>';
    ...
    $(document).ready(function () {
        $(document).on('click', '.printSelected', function () {
            ...
            if (array_to_print.length === 0) {
                ...
                $.ajax({
                    url: '<?php echo site_url(
                        "studentfee/printFeesByGroupArray"
                    ); ?>',
                    type: 'post',
