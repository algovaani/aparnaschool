...
<div class="content-wrapper">
    <section class="content-header">
        <h1><i class="fa fa-newspaper-o"></i> <?php echo $this->lang->line('generate_certificate'); ?>
            <a href="<?php echo site_url('admin/report/issued_certificate_report'); ?>" class="btn btn-primary btn-sm pull-right"><i class="fa fa-list"></i> <?php echo $this->lang->line('issued_certificate_report'); ?></a>
        </h1>
    </section>
    <!-- Main content -->
