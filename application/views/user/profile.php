                                                    ...
                                                    ?>
                                                        ...
                                                        if (!empty($transport_fees)) {
                                                            foreach ($transport_fees as $transport_fee_key => $transport_fee_value) {
                                                                ...
                                                                $total_amount          +=  $feetype_balance>0?$transport_fee_value->fees:0;
                                                        ...
                                                        <tr class="box box-solid total-bg">
                                                                ...
                                                                <td class="text text-right"><?php
                                                                                            ...
                                                                                            ?></td>
                                                                <td class="text text-right"><?php
                                                                                            echo $currency_symbol . amountFormat($total_amount-($total_discount_amount + $total_deposite_amount));
                                                                                            ?></td>
                                                        </tr>
                                                        <?php
                                                    }
