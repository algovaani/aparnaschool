...
if (isset($this->customlib)) {
    ...
    if (isset($role['name']) && strtolower($role['name']) === 'super admin') {
        $is_superadmin = true;
    }
}
$feeReadonlyAttr = $is_superadmin ? '' : 'disabled readonly';
...
// print_r($transport_fees);
                                                                 ?>
                                                              <select id="specialistOpt" class="form-control" id="transport_feemaster_id" name="transport_feemaster_id[]" multiple="multiple"  <?php echo $feeReadonlyAttr; ?>>
                                                     <?php
...
echo set_value('hostel_id', $student['hostel_id']) == $hostel_value['id'] ? "selected='selected'" : "";
    ...
    ?>
<input type="hidden" name="total_post_fees" value="<?php echo ($view_total_fees); ?>" <?php echo $feeReadonlyAttr; ?>>
...
foreach ($feesessiongroup_model as $feesessiongroup_key => $feesessiongroup_value) {
        ...
        if($feesessiongroup_value->nature=='custom' && $feesessiongroup_value->student_id!=$id){
            ...
            if ($feesessiongroup_value->student_fees_master_id > 0) {
                ?>
                                <input type="hidden" name="prev_fees_group[]" value="<?php echo $feesessiongroup_value->id ?>" <?php echo $feeReadonlyAttr; ?>>
                                            <?php
}
    ...
    <div class="panel panel-default1">
      <div class="panel-heading pt5 pb5">
         <h6 class="panel-title panel-title1 overflow-hidden">
            <input class="fee_group_chk vertical-middle" type="checkbox" name="fee_session_group_id[]" value="<?php echo $feesessiongroup_value->id; ?>" <?php echo set_checkbox('fee_session_group_id[]', $feesessiongroup_value->id, ($feesessiongroup_value->student_fees_master_id > 0) ? true : false); ?> class="fee_group_chk vertical-middle" <?php echo $feeReadonlyAttr; ?>>
                            ...
                            <div class="tshadow bozero">
                                ...
                                <div class="around10">
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                <label>Choose Subjects</label><small class="req"> *</small>
                                                <p><?php
                                                        if (isset($student)) {
                                                        ?>
                                                            <option value="<?php echo $student['id']; ?>" selected="selected">
                                                ...
                                                <?php 
                                                ?>
                                                <select name="subject_name[]" class="form-select" id="choices-multiple-remove-button" placeholder="Choose subject" multiple>
                                                    <option value="">--select--</option>
                                                    <?php
                                                        if (isset($subject_group)) {
                                                            foreach ($subject_group as $list) {
                                                                ?>
                                                                <option value="<?php echo $list['id'] ?>" 
                                                                    <?php if (set_value('subject_name') == $list['id']) {
                                                                    echo "selected=selected";
                                                                    }
                                                                    ?>><?php echo $list['name'] ;?>
                                                                </option>
                                    ...
                                    <div class="row">
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                <label for="exampleInputClassdate">
                                                 pramoted next class name & date
                                                </label>
                                                <input id="class_date" name="class_date" placeholder="" type="text" class="form-control"  value="<?php echo $student['class_date']; ?>" />
                                                <!-- <span class="text-danger"><?php //echo form_error('class_date'); ?></span> -->
                                            </div>
                                        </div>
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                <label for="exampleInputCraftsub">
                                                Craft subject passed yes or no
                                                </label>
                                                <input id="crft_sub" name="crft_sub" placeholder="" type="text" class="form-control"  value="<?php echo set_value('crft_sub', $student['crft_sub']); ?>" />
                                                <!-- <span class="text-danger"><?php //echo form_error('crft_sub'); ?></span> -->
                                            </div>
                                        </div>
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                <label for="exampleInputCoresub">
                                                 Core subject passed yes or no
                                                </label>
                                                <input id="core_sub" name="core_sub" placeholder="" type="text" class="form-control"  value="<?php echo set_value('core_sub', $student['core_sub']); ?>" />
                                                <!-- <span class="text-danger"><?php //echo form_error('core_sub'); ?></span> -->
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row">
                                    <div class="col-md-4">
                                            <div class="form-group">
                                                <label for="exampleInputAnnualcharg">
                                                Total number of school days
                                                </label>
                                                <input id="tot_school_days" name="tot_school_days" placeholder="" type="text" class="form-control"  value="<?php echo set_value('tot_school_days', $student['tot_school_days']); ?>" />
                                                <!-- <span class="text-danger"><?php //echo form_error('tot_school_days'); ?></span> -->
                                            </div>
                                        </div>
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                <label for="exampleInputConcessionReciept">
                                                 take concession reciept  yes or no
                                                </label>
                                                <input id="concession_reciept" name="concession_reciept" placeholder="" type="text" class="form-control"  value="<?php echo set_value('concession_reciept', $student['concession_reciept']); ?>" />
                                                <!-- <span class="text-danger"><?php //echo form_error('concession_reciept'); ?></span> -->
                                            </div>
                                        </div>
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                <label for="exampleInputNcc">
                                                Whether NCC cadet
                                                </label>
                                                <input id="ncc_cadet" name="ncc_cadet" placeholder="" type="text" class="form-control"  value="<?php echo set_value('ncc_cadet', $student['ncc_cadet']); ?>" />
                                                <!-- <span class="text-danger"><?php //echo form_error('ncc_cadet'); ?></span> -->
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                <label for="exampleInputGamePlayed">
                                                Game played performance
                                                </label>
                                                <input id="game_play" name="game_play" placeholder="" type="text" class="form-control"  value="<?php echo set_value('game_play', $student['game_play']); ?>" />
                                                <!-- <span class="text-danger"><?php //echo form_error('game_play'); ?></span> -->
                                            </div>
                                        </div>
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                <label for="exampleInputCunduct">
                                                 genral conduct
                                                </label>
                                                <input id="cunduct" name="cunduct" placeholder="" type="text" class="form-control"  value="<?php echo set_value('cunduct', $student['cunduct']); ?>" />
                                                <!-- <span class="text-danger"><?php //echo form_error('cunduct'); ?></span> -->
                                            </div>
                                        </div>
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                <label for="exampleInputAnnualcharg">
                                                Annual charges collection yes or no
                                                </label>
                                                <input id="anul_chrg_colct" name="anul_chrg_colct" placeholder="" type="text" class="form-control"  value="<?php echo set_value('anul_chrg_colct', $student['anul_chrg_colct']); ?>" />
                                                <!-- <span class="text-danger"><?php //echo form_error('anul_chrg_colct'); ?></span> -->
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                <label for="exampleInputFirstFeePaiDate">
                                                 First fee paid date
                                                </label>
                                                <input id="first_fee_paid_date" name="first_fee_paid_date" placeholder="" type="text" class="form-control"  value="<?php echo set_value('first_fee_paid_date', $student['first_fee_paid_date']); ?>" / <?php echo $feeReadonlyAttr; ?>>
                                                <!-- <span class="text-danger"><?php //echo form_error('first_fee_paid_date'); ?></span> -->
                                            </div>
                                        </div>
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                <label for="exampleInputFeePaiDate">
                                                 Last fee paid date
                                                </label>
                                                <input id="last_fee_paid_date" name="last_fee_paid_date" placeholder="" type="text" class="form-control"  value="<?php echo set_value('last_fee_paid_date', $student['last_fee_paid_date']); ?>" / <?php echo $feeReadonlyAttr; ?>>
                                                <!-- <span class="text-danger"><?php //echo form_error('last_fee_paid_date'); ?></span> -->
                                            </div>
                                        </div>
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                <label for="exampleInputFeePaiDate">
                                                 Total Days Attended Pupil 
                                                </label>
                                                <input id="pupil_attend_days" name="pupil_attend_days" placeholder="" type="text" class="form-control"  value="<?php echo set_value('pupil_attend_days', $student['pupil_attend_days']); ?>" />
                                                <!-- <span class="text-danger"><?php //echo form_error('last_fee_paid_date'); ?></span> -->
                                            </div>
                                        </div>
                                    </div>
