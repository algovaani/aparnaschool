...
class Subject_model extends MY_Model {
    ...
    public function getDataByMultipleIds($sub_id) {
        $this->db->select('*');
        $this->db->from('subjects'); // Replace 'your_table' with your actual table name
        $this->db->where_in('id', $sub_id); // Assuming 'id' is the column you're matching against
        
        $query = $this->db->get();
        return $query->result(); // Fetches data matching the multiple IDs
    }
