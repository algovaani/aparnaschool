            ...
            <div class="row">
                ...
                echo $fees_value['fee_type_code'];
                                ...
                                <form class="paddtlrb" action="<?php echo $action; ?>/_payment" method="post" id="payuForm" name="payuForm">
                                    ...
                                    <input class="form-control" type="hidden" name="email" id="email" value="<?php echo 'anupamnayak12070@gmail.com'; ?>" readonly/>
									...
									<input name="udf1" value="<?php echo $udf1 ?>" size="64" type="hidden" />  
									<input name="udf2" value="<?php echo $udf2 ?>" size="64" type="hidden" /> 
									<input name="udf3" value="<?php echo $udf3 ?>" size="64" type="hidden" /> 
									<input name="udf4" value="<?php echo $udf4 ?>" size="64" type="hidden" /> 
									<input name="udf5" value="<?php echo $udf5 ?>" size="64" type="hidden" /> 
