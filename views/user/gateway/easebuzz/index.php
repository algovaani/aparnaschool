                    ...
                    <div class="col-md-6 col-md-offset-3 mt20">
                        <div class="paymentbg">
                            ...
                            <div class="padd2 paddtzero">
                                <form action="<?php echo base_url(); ?>user/gateway/easebuzz/pay" method="post">
                                    ...
                                    ?>
                                     <tr class="border_bottom">
                                        ...
                                        <tr class="bordertoplightgray">
                                            ...
                                            <td  bgcolor="#fff" class="text-right"> <input type="text" class="form-control"  name="phone" value="<?php echo set_value('phone', $params['guardian_phone']); ?>" required readonly /><span class="alert-danger "> <?php echo form_error('phone'); ?></span></td>
                                        </tr>
                                        ...
                                        <tr class="bordertoplightgray">
                                            ...
                                            <td  bgcolor="#fff" class="text-right"> <button type="submit"  name="search"  value="" class="btn btn-info"><?php echo 'Pay with Ease'; ?>  <i class="fa fa fa-chevron-right"></i></button>  </td>
                                        </tr>
                                    </table>
                                </form>
                            </div>
