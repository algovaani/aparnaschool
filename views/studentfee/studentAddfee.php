                                                    ...
                                                    <?php
                                                        if (
                                                            ...
                                                            "paid"
                                                                        ...
                                                                        $temp_fee_discount = 0;
                                                                        if($fee_discount != $fee_value->amount){
                                                                            $temp_fee_discount = $fee_discount;
                                                                        }
                                                                        $total_deposite_amount+= ($fee_value->amount-$temp_fee_discount);    
                                                                    } elseif (
...
if(empty($fee_value->amount_detail)){
    ...
    echo amountFormat($fee_discount);
    $fee_paid_total += $fee_discount;
} else {
    $paidFinalAmount = ($fee_value->amount-$fee_discount);
    $fee_paid_total += $paidFinalAmount;
    echo amountFormat($paidFinalAmount);
}
?>
...
if ($fee_deposits_value->description == "") {
    ...
    foreach ($fee->fees as $fee_key => $fee_value) {
     ...
     if ($fee_discount == $fee_value->amount){
        $total_amount += $fee_value->amount;
        $total_discount_amount += 0;
        // $total_deposite_amount += ($fee_paid-$fee_discount);
        $total_fine_amount += $fee_fine;
        $feetype_balance = $fee_value->amount - ($fee_paid + $fee_discount);
        // $total_balance_amount += $feetype_balance;
                } else {
...
if ($fee_deposits_value->description == "") {
                ...
                ?>
                                                        ...
                                                        <td class="text text-right">
                                                            ...
                                                            echo amountFormat($fee_value->amount-$fee_deposits_value->amount_discount);
                                                            }
                                                            ?>
                                                            </td>
...
<?php echo $this->customlib->dateformat($transport_fee_value->due_date); ?>                                             </td>
                                                    ...
                                                    <?php
if ($feetype_balance == 0) {
    $total_deposite_amount += ($transport_fee_value->fees-$fee_discount);
            ?><span class="label label-success"><?php echo $this->lang->line('paid');?></span><?php //echo "--".$total_deposite_amount; ?><?php
                    ...
                    <div class="box-body">
                            ...
                            <div class="col-sm-9">
                                <div class="row">
                                    <div class="col-md-5 col-sm-5">
                                        <div class="">
                                            <input type="text" class="form-control" id="amount_discount"  value="0" <?php
                        if ($this->rbac->hasPrivilege('collect_fees', 'can_delete')) { } else { echo"readonly";} ?> >
                        ...
                        <?php 
                            ...
                            <div class="form-group">
                                                ...
                                                <input type="hidden" class="form-control" id="amount_discount"  value="0" <?php
                                if ($this->rbac->hasPrivilege('collect_fees', 'can_delete')) { } else { echo"readonly";} ?> >
                                        <div class="col-md-2 col-sm-2 ltextright">
                                            <label for="inputPassword3" class="control-label"><?php echo $this->lang->line('fine'); ?> (<?php echo $currency_symbol; ?>)<small class="req">*</small></label>
                                        </div>
