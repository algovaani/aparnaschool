                    ...
                    <form id="form1" action="<?php echo site_url('student/create') ?>" id="employeeform" name="employeeform" method="post" accept-charset="utf-8" enctype="multipart/form-data">
                        <div class="bozero">
                            ...
                            <ul class="nav nav-tabs" id="myTab" role="tablist">
                                <li class="active">
                                    <a class="nav-link active" id="student-tab" data-toggle="tab" href="#studentDetails" role="tab" aria-controls="studentDetails" aria-selected="true"><?php echo $this->lang->line('student_details'); ?></a>
                                </li>
                                <li class="">
                                    <a class="nav-link" id="parent-tab" data-toggle="tab" href="#parentDetails" role="tab" aria-controls="parentDetails" aria-selected="false"><?php echo $this->lang->line('parent_guardian_detail'); ?></a>
                                </li>
                                <li class="">
                                    <a class="nav-link" id="fees-tab" data-toggle="tab" href="#feesDetails" role="tab" aria-controls="feesDetails" aria-selected="false"><?php echo $this->lang->line('fees_details'); ?></a>
                                </li>
                                <li class="">
                                    <a class="nav-link" id="transport-tab" data-toggle="tab" href="#transportHostel" role="tab" aria-controls="transportHostel" aria-selected="false"><?php echo $this->lang->line('transport_hostel_details'); ?></a>
                                </li>
                                <li class="">
                                    <a class="nav-link" id="misc-tab" data-toggle="tab" href="#miscellaneous" role="tab" aria-controls="miscellaneous" aria-selected="false"><?php echo $this->lang->line('miscellaneous_details'); ?></a>
                                </li>
                                <li class="">
                                    <a class="nav-link" id="docs-tab" data-toggle="tab" href="#documents" role="tab" aria-controls="documents" aria-selected="false"><?php echo $this->lang->line('upload_documents'); ?></a>
                                </li>
                            </ul>

                            <div class="tab-content" id="myTabContent">

                                <div class="tab-pane fade in active" id="studentDetails" role="tabpanel" aria-labelledby="student-tab">
                                    <div class="around10">
                                        <div class="row">
                                ...
                                </div> <div class="tab-pane fade" id="parentDetails" role="tabpanel" aria-labelledby="parent-tab">
                                    <div class="around10">
                                        <div class="row">
                                ...
                                </div> <div class="tab-pane fade" id="feesDetails" role="tabpanel" aria-labelledby="fees-tab">
                                    <div class="mainstudent">
                                                                                            ...
                                                                                            <?php foreach ($feesessiongroup_value->feetypes as $fee_type_key => $fee_type_value) { ?>
                                                                                                <li class="list-group-item">
                                                                                                    <div class="displayinline stfirstdiv pl-65">
                                                                                                        <input type="checkbox" name="selected_fees[]" value="<?php echo $checkbox_value; ?>" class="month_fee_chk vertical-middle">
                                                                                                        <?php echo $fee_type_value->type . " (" . $fee_type_value->code . ")" ?>
                                                                                                    </div>
                                                                                                    <small class="due_date">
                                                                                                        <i class="fa fa-calendar"></i>
                                                                                                        <?php echo $this->customlib->dateformat($fee_type_value->due_date); ?>
                                                                                                    </small>
                                                                                                    <div class="tools">
                                        ...
                                        <div class="mainstudent discount_div">
                                            ...
                                            <h4 class="pagetitleh2"><?php echo $this->lang->line('fees_discount_details'); ?>
                                                <span class="float-right bmedium total_discount_alloted"></span>
                                            </h4>
                                            <div class="row around10">
                                                <div class="col-md-12">
                                                    <?php if (!empty($feediscountList)) { ?>
                                                        <div class="table-responsive border0">
                                                            <table class="table mb0">
                                                                <tbody>
                                                                    <?php foreach($feediscountList as $key=>$feediscount){ ?>
                                                                        <tr>
                                                                            <td colspan="3" class="mailbox-name white-space-nowrap border0">
                                                                                <div class="panel-group1 mb0">
                                                                                    <div class="panel panel-default1">
                                ...
                                </div> <div class="tab-pane fade" id="transportHostel" role="tabpanel" aria-labelledby="transport-tab">
                                    <div class="around10">
                                        <?php if ($sch_setting->route_list) {
                                            if ($this->module_lib->hasActive('transport')) { ?>
                                                <div class="bozero">
                                                    <h4 class="pagetitleh2"><?php echo $this->lang->line('transport_details'); ?></h4>
                                                    <div class="row around10">
                                                        <div class="col-md-4">
                                                            <div class="form-group">
                                        ...
                                        if ($this->module_lib->hasActive('hostel')) {
                                            if ($sch_setting->hostel_id) { ?>
                                                <div class="bozero">
                                                    <h4 class="pagetitleh2"><?php echo $this->lang->line('hostel_details'); ?></label></label></h4>
                                                    <div class="row around10">
                                                        <div class="col-md-6">
                                                            <div class="form-group">
                                ...
                                </div> <div class="tab-pane fade" id="miscellaneous" role="tabpanel" aria-labelledby="misc-tab">
                                    <div class="bozero">
                                            ...
                                            <?php if ($sch_setting->previous_school_details) { ?>
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <textarea class="form-control" rows="3" placeholder="" name="previous_school"><?php echo set_value('previous_school'); ?></textarea>
                                            ...
                                            <?php } if ($sch_setting->student_note) { ?>
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <textarea class="form-control" rows="3" placeholder="" name="note"><?php echo set_value('note'); ?></textarea>
                                ...
                                </div> <div class="tab-pane fade" id="documents" role="tabpanel" aria-labelledby="docs-tab">
    ...
    $(document).ready(function () {
        ...
        function getSectionByClass(class_id, section_id) {
            if (class_id !== "") {
                ...
                var url = "<?php $userdata = $this->customlib->getUserData(); if (($userdata["role_id"] == 2)) { echo "getClassTeacherSection"; } else { echo "getByClass"; } ?>";
                $.ajax({
                    type: "GET",
