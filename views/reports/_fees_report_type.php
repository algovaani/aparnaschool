        ...
        <div class="row">
            <div class="col-md-12">
                <div class="box box-primary">
                    ...
                    <div class="box-body">
                        <form action="<?php echo site_url('feestatus') ?>" method="post" class="class_search_form">
                                ...
                                <table class="table table-striped table-bordered table-hover examplenew">
                                    <thead>
										...
										<th>Phone</th>
                                            <?php foreach($all_fee_types as $_ft): ?>
                                                ...
                                                ?>
                                                <th><?php echo $_ft.' (Total)'; ?></th>
                                            <?php endforeach; ?>
                                            <th>Total Amt</th>
                                            <?php foreach($all_fee_types as $_ft): ?>
                                                <th><?php echo $_ft.' (Paid)'; ?></th>
                                            <?php endforeach; ?>
                                                ...
                                                <tr style="font-weight:bold;">
                                                    ...
                                                    <?php foreach($all_fee_types as $_ft): ?>
                                                        <?php 
                                                            ...
                                                            $suppper['total-'.$_ft] += $amount;
                                                            $ta += $amount;    
                                                        ?>
                                                        <td style="color:red;"><?php echo (number_format($amount, 2, '.', '')); ?></td>
                                                    <?php endforeach; ?>
                                                    <td style="color:red;"><?php echo (number_format($ta, 2, '.', '')); ?></td>

                                                    <?php foreach($all_fee_types as $_ft): ?>
                                                        <?php 
                                                            $paid_fees = $record[$_ft]['paid_fees'] ?? 0;
                                                            $suppper['paid-'.$_ft] += $paid_fees;
                                                            $tpa += $paid_fees;    
                                                        ?>
                                                        <td style="color:green;"><?php echo (number_format($paid_fees, 2, '.', '')); ?></td>
                                                    <?php endforeach; ?>
                                                    <td style="color:green;"><?php echo (number_format($tpa, 2, '.', '')); ?></td>
                                                    ...
                                                    <?php foreach($all_fee_types as $_ft): ?>
                                                        <?php 
                                                            ...
                                                            $tra += $remain_fees;    
                                                        ?>
                                                        <td style="color:orange;"><?php echo (number_format($remain_fees, 2, '.', '')); ?></td>
                                                    <?php endforeach; ?>
                                    ...
                                    <thead>
										...
										<th>Phone</th>
                                            ...
                                            <?php foreach($all_fee_types as $_ft): ?>
                                                <?php 
                                                    $tt = $suppper['total-'.$_ft] ?? 0;
                                                    $st += $tt; 
                                                ?>
                                                <th><?php echo (number_format($tt, 2, '.', '')); ?></th>
                                            <?php endforeach; ?>
                                            <th><?php echo (number_format($st, 2, '.', '')); ?></th>
                                            <?php foreach($all_fee_types as $_ft): ?>
                                                <?php 
                                                    $pt = $suppper['paid-'.$_ft] ?? 0;
                                                    $sp += $pt; 
                                                ?>
                                                <th><?php echo (number_format($pt, 2, '.', '')); ?></th>
                                            <?php endforeach; ?>
                                            <th><?php echo (number_format($sp, 2, '.', '')); ?></th>
                                            <?php foreach($all_fee_types as $_ft): ?>
                                                <?php 
