                                            ...
                                            if (empty($feearray)) {
                                                ...
                                                foreach ($feearray as $fee_key => $feeList) {
                                                   if($feeList->fee_category == "fees"){
                                                    ...
                                                    if($fee_deposits_value->amount != $fee_discount){
...
if ($feeList->fine_amount != "") {
    ...
    <?php
                                                        ...
                                                        <td class="text text-right"><?php
                                                            if($fee_paid == $fee_discount){
                                                                echo "0.00";
                                                            }else{
                                                                echo $currency_symbol . amountFormat($fee_paid-$fee_discount);
                                                            }
                                                            ?></td>
                                                        <td class="text text-right"><?php
                                                    ...
                                                    if (is_object($fee_deposits)) {
                                                        foreach ($fee_deposits as $fee_deposits_key => $fee_deposits_value) {
                                                            ...
                                                            <tr class="white-td">
                                                                ...
                                                                <?php
                                                                    if($fee_deposits_value->amount == $fee_deposits_value->amount_discount){ ?>
                                                                        <td class="text text-right"><?php echo $currency_symbol . "0.00"; ?></td>
                                                                    <?php    
                                                                    }else{ ?>
                                                                        <td class="text text-right"><?php echo $currency_symbol . amountFormat($fee_deposits_value->amount-$fee_deposits_value->amount_discount); ?></td>
                                                                    <?php    
                                                                    }
                                                                ?>
                                                    ...
                                                    <!--<td><?php echo $this->lang->line("transport_fees"); ?></td>
                                                        ...
                                                        <td class="">
                                                            <?php
                                                            if ($feetype_balance == 0 || $fee_discount == $feeList->amount || !empty($fee_discount)) {
                                                                echo $this->lang->line('paid');
                                                            } else if (!empty($feeList->amount_detail)) {
                                                                ?><?php echo $this->lang->line('partial'); ?><?php
                                                            } else {
    ...
    <?php
                                                ...
                                                ?>
                                                        ...
                                                        <td class="text text-right"><?php
                                                            ...
                                                            ?></td>
                                                        <td class="text text-right"><?php
                                                        if(amountFormat($fee_discount) == amountFormat($fee_paid)){
                                                        ...
                                                        foreach ($fee_deposits as $fee_deposits_key => $fee_deposits_value) {
                                                            ...
                                                            <tr class="white-td">
                                                                ...
                                                                if($fee_deposits_value->amount == $fee_deposits_value->amount_discount){
                                                                    ...
                                                                    echo $currency_symbol . amountFormat($fee_deposits_value->amount-$fee_deposits_value->amount_discount); 
                                                                }
                                            ...
                                            <tr class="success">
                                                ...
                                                <td class="text text-right"> <b>  <?php
                                                $paidAmount = $total_amount - ($total_deposite_amount+$total_discount_amount);
                                                $paidAmountFormatted = amountFormat($paidAmount);
                                                        echo $currency_symbol . $paidAmountFormatted;
                                                    ...
                                                    if (is_object($fee_deposits)) {
                                                        foreach ($fee_deposits as $fee_deposits_key => $fee_deposits_value) {
                                                            ...
                                                            <tr class="white-td">
                                                                ...
                                                                <td class="text text-right"><?php 
                                                                    if($fee_deposits_value->amount == $fee_deposits_value->amount_discount){
                                                                        echo $currency_symbol . amountFormat($fee_deposits_value->amount);
                                                                    }else{
                                                                        echo $currency_symbol . amountFormat($fee_deposits_value->amount-$fee_deposits_value->amount_discount); 
                                                                    }
                                                                //echo $currency_symbol . amountFormat($fee_deposits_value->amount);
                                                                ...
                                                                if($fee_deposits_value->amount == $fee_deposits_value->amount_discount){
                                                                    ...
                                                                    echo $currency_symbol . amountFormat($fee_deposits_value->amount_discount); 
                                                                }
                                                                ?></td>
                                                                <td></td>
                                                            </tr>
                                                    ...
                                                    if (is_object($fee_deposits)) {
                                                        foreach ($fee_deposits as $fee_deposits_key => $fee_deposits_value) {
                                                            ...
                                                            <tr class="white-td">
                                                                ...
                                                                <td class="text text-right"><?php echo $currency_symbol . amountFormat($fee_deposits_value->amount_fine); ?></td>
                                                                <td class="text text-right"><?php
                                                                if(amountFormat($fee_deposits_value->amount) == amountFormat($fee_deposits_value->amount_discount)){
                                                                    echo $currency_symbol . "0.00";
                                                                }else{
                                                                    echo $currency_symbol . amountFormat($fee_deposits_value->amount-$fee_deposits_value->amount_discount); 
                                                                }
    ...
    <?php
                                                    ...
                                                    if (is_object($fee_deposits)) {
                                                        foreach ($fee_deposits as $fee_deposits_key => $fee_deposits_value) {
                                                            ...
                                                            <tr class="white-td">
                                                                ...
                                                                <td class="text text-right"><?php echo $currency_symbol . amountFormat($fee_deposits_value->amount_fine); ?></td>
                                                                <td class="text text-right"><?php 
                                                                if(amountFormat($fee_deposits_value->amount_discount) == amountFormat($fee_deposits_value->amount)){
                                                                    echo $currency_symbol . "0.00";
                                                                }else{
                                                                    echo $currency_symbol . amountFormat($fee_deposits_value->amount-$fee_deposits_value->amount_discount);
                                                                }
                                            ...
                                            <tr class="success">
                                                ...
                                                <td class="text text-right"> <b>  <?php
                                                        ...
                                                        ?></b></td>
                                                <td class="text text-right"> <b>  <?php
                                                $paidAmount = $total_amount - $total_deposite_amount;
                                                $paidAmountFormatted = amountFormat($paidAmount);
                                                        echo $currency_symbol . $paidAmountFormatted;
                                                        ?></b></td>  <td class="text text-right"></td>
                                            </tr>
