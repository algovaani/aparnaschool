...
?>
                            ...
                            <div class="col-sm-2 col-lg-2 col-md-2">
                                <div class="form-group">
                                    ...
                                    <select class="form-control"  name="collect_by" <?php if($this->rbac->hasPrivilege('collect_fees', 'can_delete') == false) { echo 'required';}?> >
                                        <option value=""><?php echo $this->lang->line('select') ?></option>
                                        <?php
...
<div class="box-header ptbnull">
    ...
    foreach ($results as $key => $value) {
        ...
        foreach ($value as $collect) {
            ...
            $guardian_phone[] = $collect['guardian_phone'];
            $guardian_name[] = $collect['guardian_name'];
        ...
        $paidAmount = 0 ;
        $discountAmount = 0 ;
        foreach ($amountLabel as $amountLabel_val) { 
            $paidAmount = $amountLabel_val;
            
        }foreach ($discountLabel as $discountLabel_val) {
            $discountAmount = $discountLabel_val;
        }
        if($t>0 && $discountAmount != $paidAmount){
        ?>
                                            <tr>
                                                <td>
        ...
        ?>
                                                ...
                                                <td >
                                                    <table width="100%"><?php foreach ($guardian_name as $guardian_name) {
            ?>
                                                            <tr><td class="text-left-md"><?php echo $guardian_name; ?></td></tr>
                                                        <?php }
        ?>
                                                    </table>
                                                </td>
                                                   ...
                                                   <td >
                                                    <table width="100%"><?php foreach ($guardian_phone as $guardian_phone) {
            ?>
                                                            <tr><td class="text-left-md"><?php echo $guardian_phone; ?></td></tr>
                                                        <?php }
        ?>
                                                    </table>
                                                </td>
