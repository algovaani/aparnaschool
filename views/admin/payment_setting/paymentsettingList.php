            ...
            <div class="col-md-10">
                <div class="nav-tabs-custom box box-primary theme-shadow">
                    ...
                    <ul class="nav nav-tabs nav-tabs2">
						...
						<li><a href="#tab_25" data-toggle="tab">Easebuzz</a></li>
                    </ul>
...
?>
                            ...
                            <form role="form" id="easebuzz" id="custom" action="<?php echo site_url('admin/paymentsettings/easebuzz') ?>" class="form-horizontal" method="post">
                                <div class="box-body minheight149">
                                    <div class="row">
                                            <div class="col-md-7">
                                                <?php $easebuzz_result = check_in_array('easebuzz', $paymentlist); ?>
                                                <div class="form-group">
                                                    <label class="col-sm-5 control-label"><?php echo $this->lang->line('key'); ?><small class="req"> *</small>
                                                    </label>
                                                    <div class="col-sm-7">
                                                        <input type="text" class="form-control" name="key" value="<?php echo isset($easebuzz_result->api_secret_key) ? $easebuzz_result->api_secret_key : ""; ?>">
                                                        <span class="text text-danger key_error"></span>
                                                    </div>
                                                </div>
                                                <div class="form-group">
                                                    <label class="col-sm-5 control-label"><?php echo $this->lang->line('salt'); ?><small class="req"> *</small>
                                                    </label>
                                                    <div class="col-sm-7">
                                                        <input type="text" class="form-control" name="salt" value="<?php echo isset($easebuzz_result->salt) ? $easebuzz_result->salt : ""; ?>">
                                                        <span class="text text-danger salt_error"></span>
                                                    </div>
                                                </div>
                                                <!-- processing charge -->
                                                  <div class="form-group">
                                                    ...
                                                    <div class="col-lg-7 col-md-7 col-sm-7 col-xs-12">
                                                        <div id="input-type" class="row">
                                                            <div class="col-sm-4">
                                                                <label class="radio-inline">
                                                                    <input  checked="checked"  name="charge_type" class="finetype" onclick="get_payment_type('easebuzz_charge_value',this.value)" id="charge_type" value="none" type="radio" <?php if(isset($easebuzz_result->charge_type) && $easebuzz_result->charge_type=='none'){ ?> checked="checked" <?php } ?>><?php echo $this->lang->line('none'); ?>    
                                                                </label>
                                                            </div>
                                                            <div class="col-sm-4">
                                                                <label class="radio-inline">
                                                                    <input <?php if(isset($easebuzz_result->charge_type) && $easebuzz_result->charge_type=='percentage'){ ?> checked="checked" <?php } ?> onclick="get_payment_type('easebuzz_charge_value',this.value)" name="charge_type" class="finetype" id="charge_type" value="percentage" type="radio"><?php echo $this->lang->line('percentage'); ?> (%)       
                                                                </label>
                                                            </div>
                                                            <div class="col-sm-4">
                                                                <label class="radio-inline" class="control-label col-lg-5 col-md-5 col-sm-5">
                                                                    <input <?php if(isset($easebuzz_result->charge_type) && $easebuzz_result->charge_type=='fix'){ ?> checked="checked" <?php } ?> onclick="get_payment_type('easebuzz_charge_value',this.value)" name="charge_type" class="finetype" id="charge_type" value="fix" type="radio"><?php echo $this->lang->line('fix_amount'); ?> (<?php echo $currency_symbol; ?>)
                                                                </label>
                                                            </div> 
                                                        </div>
                                                    </div>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-lg-7 col-md-7 col-sm-7 col-xs-12">
                                                        <input id="easebuzz_charge_value" name="easebuzz_charge_value" placeholder="" type="text" class="form-control"  value="<?php echo isset($easebuzz_result->charge_value) ? $easebuzz_result->charge_value : ""; ?>" />
                                                        <span class=" text text-danger easebuzz_charge_value_error"></span>
                                                    </div>
                                                </div>
                                                <!-- processing charge -->
                                            </div>
                                            <div class="col-md-5 text text-center disblock">
                                                <a href="https://www.easebuzz.in" target="_blank">
                                                    <h5><?php echo $this->lang->line('payment_gateway_for_india'); ?></h5>
                                                    <img src="<?php echo $this->media_storage->getImageURL('backend/images/easebuzz.png'); ?>" width="200"><p>https://www.easebuzz.in</p></a>
                                            </div>
                                    </div>
                                </div>
                                <!-- /.box-body -->
                                <div class="box-footer">
                                    <div class="row">
                                        <div class="col-md-6 col-sm-6 col-xs-12 col-md-offset-3">
                                            <?php if ($this->rbac->hasPrivilege('payment_methods', 'can_edit')) {?>
                                                <button type="submit" class="btn btn-primary easebuzz_save" data-loading-text="<i class='fa fa-spinner fa-spin '></i> <?php echo $this->lang->line('save'); ?>"><?php echo $this->lang->line('save'); ?></button>
                                            <?php }?>
                                        </div>
                                    </div>
                                </div>
...
?>>
                                ...
                                <div class="radio">
                                    <label>
                                        <input type="radio"  name="payment_setting" value="easebuzz" <?php
if ($radio_check == 'easebuzz') {
    echo "checked";
}
?>>
                                        <?php echo 'Easebuzz'; ?>
...
<script type="text/javascript">
    ...
    $("#easebuzz").submit(function (e) {
        $("[class$='_error']").html("");
        var $this = $(".easebuzz_save");
        $this.button('loading');
        var url = $(this).attr('action');
