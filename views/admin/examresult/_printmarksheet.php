...
if (empty($marksheet)) {
    ...
    <div style="width: 100%; margin-left: auto; margin-right: auto; border: 0px solid #000; padding-top:400px; margin-top:400px;">
                                                    ...
                                                    if ($exam->exam_group_type != "gpa") {
                                                        ...
                                                        <td>
                                                            ...
                                                            if ($exam_result_value->attendence == "absent") {
                                                                echo "&nbsp;" . "AB";
                                                                $absent_status++;
                                                            }else if ($exam_result_value->get_marks < $exam_result_value->min_marks) {
                 ...
                 <table cellpadding="0" cellspacing="0" width="100%" class="">                    
                    <tr>                        
                        ...
                        <td valign="top" style="font-weight: bold;">
                              <?php
                                 if($result_status <= 1 && $exam->exam_group_type == "average_passing"){
