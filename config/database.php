...
// Same as application/config/database.php: database=aparna_school, user=root, password=blank
$db['default'] = array(
    'dsn'          => '',
    'hostname'     => 'localhost',
    'username'     => 'root',
    'password'     => '',
    'database'     => 'aparna_school',
    'dbdriver' => 'mysqli',
    'dbprefix'     => '',
    'pconnect'     => false,
...
if ($mysqli && $mysqli->connect_errno) {
    // Log error but don't exit - let CodeIgniter handle it
